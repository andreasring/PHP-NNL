<?php
  ...
  echo('1 and 0 should be 0 and is: '.$network->calculate([1, 0])[0]);
  echo('<br>');
  echo('0 and 1 should be 0 and is: '.$network->calculate([0, 1])[0]);
  echo('<br>');
  echo('1 and 1 should be 1 and is: '.$network->calculate([1, 1])[0]);
  echo('<br>');
  echo('0 and 0 should be 1 and is: '.$network->calculate([0, 0])[0]);
  echo('<br>');
